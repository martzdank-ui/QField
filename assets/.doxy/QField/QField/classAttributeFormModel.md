...
| property bool | [**isWizard**](classAttributeFormModel.md#property-iswizard-12)  <br> |
...
| signal void | [**isWizardChanged**](classAttributeFormModel.md#signal-iswizardchanged)  <br> |
...
```C++
bool AttributeFormModel::isWizard;
```
...
```C++
void AttributeFormModel::isWizardChanged;
```
